    ...
    <>
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-12" role="main">
        ...
        <section className="text-center mb-16 animate-fade-in" aria-labelledby="hero-title">
          <h1 id="hero-title" className="text-4xl sm:text-5xl lg:text-6xl font-bold mb-6 text-brand-dark dark:text-brand-light">
            Bienvenue sur <span className="text-brand-primary">LegalHaze</span>
          </h1>
          <p className="text-xl sm:text-2xl text-gray-600 dark:text-white mb-8 max-w-3xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-16" role="list">
          <Link to="/guide" className="group transform hover:-translate-y-1 transition-all duration-300" role="listitem">
            <div className="bg-white dark:bg-gray-800 p-8 rounded-xl shadow-md hover:shadow-xl transition-shadow h-full" aria-labelledby="guide-title">
              ...
              <ul className="space-y-3 text-gray-700 dark:text-white">
          ...
          <Link to="/etude" className="group transform hover:-translate-y-1 transition-all duration-300" role="listitem">
            <div className="bg-white dark:bg-gray-800 p-8 rounded-xl shadow-md hover:shadow-xl transition-shadow h-full" aria-labelledby="etude-title">
          ...
          <Link to="/annexes" className="group transform hover:-translate-y-1 transition-all duration-300" role="listitem">
            <div className="bg-white dark:bg-gray-800 p-8 rounded-xl shadow-md hover:shadow-xl transition-shadow h-full" aria-labelledby="annexes-title">
          ...
          <div className="bg-white dark:bg-gray-800 p-8 rounded-xl shadow-md" role="complementary" aria-labelledby="about-title">
